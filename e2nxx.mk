...
PRODUCT_COPY_FILES += \
    ...
    device/lge/e2nxx-common/wcnss/p2p_supplicant.conf:system/etc/wifi/p2p_supplicant.conf \
    device/lge/e2nxx-common/wcnss/p2p_supplicant_overlay.conf:system/etc/wifi/p2p_supplicant_overlay.conf \
    device/lge/e2nxx-common/wcnss/wpa_supplicant.conf:system/etc/wifi/wpa_supplicant.conf \
